...
async function main() {
    ...
    const BfxVaultU = await ethers.getContractFactory("BfxVaultU");
    ...
    const vaultU = await upgrades.deployProxy(BfxVaultU,
        [
            timelockAddress,
            vaultOwner,
            bfxAddress,
    ...
    console.log("BfxVaultU deployed to:", await vaultU.getAddress());
